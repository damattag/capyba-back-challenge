...
var MailController_exports = {};
__export(MailController_exports, {
  default: () => MailController_default
});
module.exports = __toCommonJS(MailController_exports);
...
var MailController = class {
  async emailVerification(req, res, next) {
    try {
      ...
      if (!mailResponse) {
        throw (0, import_http_errors.default)(503, "Erro ao enviar e-mail.");
      }
      res.status(200).json({
