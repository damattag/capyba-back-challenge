...
__export(CommentController_exports, {
  default: () => CommentController_default
});
...
var CommentController = class {
  ...
  async readByPost(req, res, next) {
    try {
      ...
      if (!postExists) {
        throw (0, import_http_errors.default)(404, "Post n\xE3o encontrado.");
      }
      res.status(200).json({
        data: {
          comments,
  ...
  async read(req, res, next) {
    try {
      ...
      if (!comment) {
        throw (0, import_http_errors.default)(404, "Coment\xE1rio n\xE3o encontrado.");
      }
      res.status(200).json({
        data: comment,
