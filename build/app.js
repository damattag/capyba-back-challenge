...
var UserSchema = import_zod2.z.object({
  name: import_zod2.z.string({ required_error: "O nome \xE9 obrigat\xF3rio." }),
  email: import_zod2.z.string({ required_error: "O e-mail \xE9 obrigat\xF3rio." }).email({ message: "O e-mail \xE9 inv\xE1lido." }),
  password: import_zod2.z.string({ required_error: "A senha \xE9 obrigat\xF3ria." }).min(8, { message: "A senha deve ter no m\xEDnimo 8 caracteres." }).regex(/[a-z]/i, { message: "A senha deve ter pelo menos uma letra." }).regex(/[0-9]/, { message: "A senha deve ter pelo menos um n\xFAmero." }),
  image: import_zod2.z.string({ required_error: "A imagem \xE9 obrigat\xF3ria." }),
  acceptedTerms: import_zod2.z.boolean({ required_error: "Os termos s\xE3o obrigat\xF3rios." }),
...
var UserEmailVerificationSchema = import_zod2.z.object({
  email: import_zod2.z.string({ required_error: "O e-mail \xE9 obrigat\xF3rio." }).email({ message: "O e-mail \xE9 inv\xE1lido." }),
  token: import_zod2.z.string({ required_error: "O token \xE9 obrigat\xF3rio." }).min(6, { message: "O token deve ter 6 caracteres." }).max(6, { message: "O token deve ter 6 caracteres." })
});

// src/DTOs/Post.ts
var import_zod3 = require("zod");
var PostSchema = import_zod3.z.object({
  title: import_zod3.z.string({ required_error: "O t\xEDtulo \xE9 obrigat\xF3rio." }),
  ...
  published: import_zod3.z.boolean({
...
var PostGetSchema = import_zod3.z.object({
  ...
  isDraft: import_zod3.z.coerce.boolean({
    invalid_type_error: "O status de publica\xE7\xE3o deve ser um booleano."
  }).optional(),
...
var CommentSchema = import_zod4.z.object({
  ...
  postId: import_zod4.z.string({ required_error: "O id do post \xE9 obrigat\xF3rio." }),
  commentParentId: import_zod4.z.string({
...
var CommentGetSchema = import_zod4.z.object({
  ...
  isEdited: import_zod4.z.coerce.boolean({
